...
public enum RecordingStorage {
    public static func recordingsDirectory(fileManager: FileManager = .default) -> URL {
        // Keep the on-disk location stable across the BehavioContext rename.
        fileManager.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
            .appendingPathComponent("BehavioContext", isDirectory: true)
...
public actor FileRecordingHistoryStore: RecordingHistoryStore {
    ...
    private static func recordingDate(
        ...
        formatter.dateFormat = "'Behavio Context' yyyy-MM-dd HH-mm-ss"
        // Ignore collision suffixes appended after the recording timestamp.
        let timestamp = String(directoryName.prefix("Behavio Context 0000-00-00 00-00-00".count))
...
public enum RecordingHistoryError: Error, LocalizedError, Sendable {
    ...
    public var errorDescription: String? {
        "The recording is outside BehavioContext's sandboxed recordings directory."
    }
}
