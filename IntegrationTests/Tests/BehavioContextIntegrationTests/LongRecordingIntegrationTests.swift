...
private func makeVideoSampleBuffer(
    ...
    guard pixelStatus == kCVReturnSuccess, let pixelBuffer else {
        throw NSError(domain: "BehavioContextIntegrationTests", code: Int(pixelStatus))
    }
    ...
    guard formatStatus == noErr, let formatDescription else {
        throw NSError(domain: "BehavioContextIntegrationTests", code: Int(formatStatus))
    }
    ...
    guard sampleStatus == noErr, let sampleBuffer else {
        throw NSError(domain: "BehavioContextIntegrationTests", code: Int(sampleStatus))
    }
    return sampleBuffer
}
